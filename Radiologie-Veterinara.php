                ...
                <div class="col-lg-7">
                    <div class="hero-left">
                        <div class="common-title">
                            <h1 class="title-animation"><span>Radiologie</span> Veterinara</h1>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-left">
                        ...
                        <div class="btn-box animate-btn margin-top-30">
                            <a href="doctor.html" class="btn1">Alege medicul veterinar preferat</a>
                            <a href="contact.html" class="btn2">Contacteaza-ne</a>
                        </div>
                    </div>
                </div>
                <div class="hero-right">
                ...
                <div class="booking-form padding-bottom-40">
                    <form action="#">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <button class="btn1" type="submit">Programeaza acum !</button>
                            </div>
                        </div>
...
<div class="faq-area padding-top-115">
    <div class="faq-shapes">
        ...
        <img src="assets/images/x-ray.png" alt="" class="vec2 wow zoomIn">
    </div>
    <div class="container">
                    ...
                    <div id="accordion" class="accordion-wrapper">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h6>
                                    <a href="#" data-toggle="collapse" class="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                       Radiologie digitala : Caine/Pisica
                                    </a>
                                </h6>
                            </div>
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Consultatie Specialitate - Radiologie : 140 RON</p>
                                    <p>Examen Radiologic - 1 expunere : 140 RON</p>
                                    <p>Examen Radiologic - 2 expuneri : 190 RON</p>
                                    <p>Examen Radiologic - 3 expuneri : 240 RON</p>
                                    <p>Examen Radiologic - 4 expuneri : 340 RON</p>
                                    <p>Examen Radiologic - 5 expuneri : 390 RON</p>
                                    <p>Examen Radiologic - Displazie sold/cot : 400-600 RON</p>
                                    <p>Examen Radiologic + Substanta de contrast - Caine : 700-1000 RON</p>
                                    <p>Examen Radiologic + Substanta de contrast - Pisica : 700-1000 RON</p>
                                    <p>Interpretare Radiologica : 140 RON</p>
