                ...
                <div class="col-lg-7">
                    <div class="hero-left">
                        <div class="common-title">
                            <h1 class="title-animation"><span>Microchipare - Inregistrare</span> RECS si Eliberare Pasaport UE</h1>
                        </div>
...
<div class="faq-area padding-top-115">
    <div class="faq-shapes">
        ...
        <img src="assets/images/chip.png" alt="" class="vec2 wow zoomIn">
    </div>
    <div class="container">
                    ...
                    <div id="accordion" class="accordion-wrapper">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                   <p>Pasaport : 200 RON</p>
                                    <p>Implantare microchip : 200 RON</p>
                                    <p>Inregistrare RECS : 100 RON</p>
                                    <p>Carnet Sanatate : 50 RON</p>
                                    <p>Viza Pasaport : 300 RON</p>
                                </div>
                            </div>
                        </div>
