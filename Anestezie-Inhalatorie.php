                ...
                <div class="col-lg-7">
                    <div class="hero-left">
                        <div class="common-title">
                            <h1 class="title-animation"><span>Anestezie</span></h1>
                        </div>
                    ...
                    <div id="accordion" class="accordion-wrapper">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Neuroleptanalgezie (Clasica) - Greutate mai mica de 10 kg : 170-240 RON </p>
                                    <p>Neuroleptanalgezie (Clasica) - Greutate intre 10 kg - 35 kg : 240-340 RON</p>
                                    <p>Neuroleptanalgezie (Clasica) - Greutate mai mare de 35 kg 340-490 RON</p>
                                    <p>Anestezie Inhalatorie - Greutate mai mica de 10 kg : 600-700 RON</p>
                                    <p>Anestezie Inhalatorie - Greutate intre 10 kg - 35 kg : 600-700 RON</p>
                                    <p>Anestezie Inhalatorie - Greutate mai mare de 35 kg : 640-840 RON</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Neuroleptanalgezie (Clasica) : 170-240 RON</p>
                                    <p>Anestezie Inhalatorie : 300-500 RON</p>
                                </div>
                            </div>
                        </div>
                    </div>
