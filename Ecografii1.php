    ...
    <div class="container">
        <div class="row justify-content-center">
            <nav aria-label="breadcrumb">
                <h2 class="page-title">Ecografii</h2>
                <ol class="breadcrumb text-center">
                    <li class="breadcrumb-item"><a href="index.php">Acasa</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Ecografii</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="ser-cont wow fadeInUp">
                    <img src="assets/images/Ecorafie.jpeg" alt="">
                    <h3 class="margin-bottom-20">Ecografii</h3>
                    <p>Ecografia veterinară este o unealtă valoroasă în diagnosticul și gestionarea bolilor și afecțiunilor la animale, contribuind la îmbunătățirea îngrijirii medicale și la promovarea bunăstării animalelor.</p>
