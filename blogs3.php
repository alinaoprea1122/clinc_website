        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="blog-content-area wow fadeInUp margin-top-50">
                    <div class="single-blog-content">
                        <div class="img-box vdo-box">
                            <img src="assets/images/animals14.jpeg" alt="">
                            <div class="vdo_pop">
                                <a class="popup-link" href="https://www.youtube.com/watch?v=yBign8Zqe8E"><span
                        ...
                        <div class="cont-box">
                            ...
                            <h3 class="margin-top-20"><a href="#"">10 Tipuri de Plante Toxice pentru Caini</a></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="blog-content-area wow fadeInUp margin-top-50">
                    <div class="single-blog-content">
                        <div class="img-box vdo-box">
                            <img src="assets/images/animals15.jpeg" alt="">
                            <div class="vdo_pop">
                                <a class="popup-link" href="https://www.youtube.com/watch?v=4yIc0pVFgVg"><span
                                        class="item-ripple"><i class="fas fa-play"></i></span></a>
                            </div>
                        </div>
                        <div class="cont-box">
                            ...
                            <h3 class="margin-top-20"><a href="#"">10 Tipuri de Plante Toxice pentru Pisici</a></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="template-pagination margin-bottom-30 wow fadeInUp">
                    <ul>
                        ...
                        <li><a  href="blogs2.php">2</a></li>
                        <li><a  class="active" href="blogs3.php">3</a></li>
