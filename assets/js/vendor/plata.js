...
function doFun(){
    tColorA.style.color="#e07e8f";
    tColorB.style.color="#444";
    tColorC.style.color="#444";
    iconA.style.color="#e07e8f";
...
function doFunA(){
    ...
    tColorB.style.color="#e07e8f";
    tColorC.style.color="#444";
    iconA.style.color="#aaa";
    iconB.style.color="#e07e8f";
    iconC.style.color="#aaa";
...
function doFunB(){
    tColorA.style.color="#444";
    tColorB.style.color="#444";
    tColorC.style.color="#e07e8f";
    iconA.style.color="#aaa";
    iconB.style.color="#aaa";
    iconC.style.color="#e07e8f";
    cDetails.style.display="none";
}
