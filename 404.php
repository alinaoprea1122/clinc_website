        ...
        <div class="container">
            <div class="row justify-content-center">
                <nav aria-label="breadcrumb">
                    <h2 class="page-title">Pagina de Eroare</h2>
                    <ol class="breadcrumb text-center">
                        <li class="breadcrumb-item"><a href="index.php">Acasa</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Pagina de Eroare</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container d-flex align-items-center justify-content-center">
            <div class="error-wrapper text-center">
                <div class="error-title margin-bottom-50">
                    <h2 class="wow fadeInUp">Ups...Pagina nu a fost gasita !</h2>
                </div>
                <div class="error-img">
                    <img src="assets/images/404.png" alt="">
                </div>
                <div class="error-btn margin-top-60">
                    <a href="index.php" class="btn1 wow fadeInUp">Inapoi Acasa !</a>
                </div>
            </div>
        </div>
    </div>
