                ...
                <div class="col-lg-7">
                    <div class="hero-left">
                        <div class="common-title">
                            <h1 class="title-animation"><span>Stomatologie</span> Veterinara</h1>
                        </div>
...
<div class="faq-area padding-top-115">
    <div class="faq-shapes">
        ...
        <img src="assets/images/tooth-cleaning.png" alt="" class="vec2 wow zoomIn">
    </div>
    <div class="container">
                    ...
                    <div id="accordion" class="accordion-wrapper">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                   <p>Consultatie Stomatologica : 50 RON</p>
                                    <p>Consultatie Instructaj de periaj corect : 30 RON</p>
                                    <p>Consultatie Stomatologica cu stabilirea planului de tratament : 140 RON</p>
                                    <p>Radiografii Dentare (1 pozitie) : 90 RON</p>
                                    <p>Detartraj (Scalare , periere , polisare , florizare) - In functie de talia animalului : 300-350 RON</p>
                                    <p>Detartraj - In functie de talia animalului : 300-350 RON</p>
                                </div>
                            </div>
                        </div>
                    </div>
