                ...
                <div class="col-lg-7">
                    <div class="hero-left">
                        <div class="common-title">
                            <h1 class="title-animation"><span>Tratamente</span> Specifice</h1>
                        </div>
...
<div class="faq-area padding-top-115">
    <div class="faq-shapes">
        ...
        <img src="assets/images/medicament.png" alt="" class="vec2 wow zoomIn">
    </div>
    <div class="container">
                    ...
                    <div id="accordion" class="accordion-wrapper">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h6>
                                    <a href="#" data-toggle="collapse" class="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                       Tratamente Uzuale : Luni-Sambata
                                    </a>
                                </h6>
                            </div>
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Orar : 12:00-18:00</p>
                                    <p>Doctori : Dr. Raluca Popescu</p>
                                    <p>Asistent : Andreea Ionescu</p>
                                    <p> Pret : 300 RONs</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-header" id="headingTwo">
                                <h6>
                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                       Tratamente perfuzabile : Luni-Sambata (Pisica)
                                    </a>
                                </h6>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThree">
                                <h6>
                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        Tratamente Perfuzabile : Luni-Sambata (Caine)
                                    </a>
                                </h6>
                            </div>
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Orar: 12:00-18:00</p>
                                    <p>Doctori: Dr.Elena Diaconescu</p>
                                    <p>Asistent: Ana-Maria Cristescu</p>
                                    <p>Pret :100 RON</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingFour">
                                <h6>
                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                        Tratamente Injectabile : Luni-Sambata (Pisica)
                                    </a>
                                </h6>
                            </div>
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Orar: 12:00-18:00</p>
                                    <p>Doctori : Dr.Andreea Lorescu</p>
                                    <p>Asistent: Andreea Ionescu</p>
                                    <p>Pret:50 RON</p>
                                </div>
                            </div>
                            ...
                            <div class="card-header" id="headingFive">
                                <h6>
                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                       Tratamente Injectabile : Luni-Vineri (Caine)
                                    </a>
                                </h6>
                            </div>
